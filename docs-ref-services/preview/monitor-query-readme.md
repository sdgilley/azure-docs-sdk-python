...
ms.service: monitor
---
# Azure Monitor Query client library for Python - version 1.0.4a20221004001 
...
- A [TokenCredential](/python/api/azure-core/azure.core.credentials.tokencredential?view=azure-python) implementation, such as an [Azure Identity library credential type](/python/api/overview/azure/identity-readme?view=azure-python#credential-classes).
